...
import { WorkspaceView } from "atom";
import DecorationExample from "../lib/decoration-example";
...
describe("DecorationExample", function() {
  ...
  beforeEach(function() {
    ...
    runs(function() {
      ...
      return (activationPromise = atom.packages
        .activatePackage("decoration-example")
  ...
  describe("when the toggle buttons are clicked", function() {
    ...
    describe("when the gutter toggle button is clicked", () =>
      it("adds a decoration to the gutter and removes it", function() {
        ...
        decorationExampleView.gutterToggle.click();
        return expect(
          editorView.find(".gutter .line-number-green")
        ).toHaveLength(0);
      }));

    describe("when the line toggle button is clicked", () =>
      it("adds a decoration to the lines and removes it", function() {
    ...
    return describe("when the highlight toggle button is clicked", () =>
      it("adds a decoration for the highlight and removes it", function() {
        ...
        decorationExampleView.highlightToggle.click();
        return expect(editorView.find(".highlight-green .region")).toHaveLength(
          0
        );
      }));
  });
  ...
  return describe("when the color cycle buttons are clicked", function() {
    ...
    describe("when the gutter color cycle button is clicked", () =>
      it("cycles through the gutter decoration's colors", function() {
        decorationExampleView.gutterToggle.click();
        expect(editorView.find(".gutter .line-number-green")).toHaveLength(2);
    ...
    describe("when the line color cycle button is clicked", () =>
      it("cycles through the line decoration's colors", function() {
        decorationExampleView.lineToggle.click();
        expect(editorView.find(".line.line-green")).toHaveLength(2);
    ...
    return describe("when the highlight color cycle button is clicked", () =>
      it("cycles through the highlight decoration's colors", function() {
        decorationExampleView.highlightToggle.click();
        expect(editorView.find(".highlight-green .region")).toHaveLength(2);
